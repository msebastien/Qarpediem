 ...
 *  @arg	'7' if input port parameter error
 */
uint8_t arduPiLoRaWAN::sendConfirmed(uint8_t port, uint8_t* payload, uint16_t length)
{
	uint8_t status;
	char ans1[20];
	char ans2[20];
	...
	sprintf(_command,(char*)pgm_read_word(&(table_LoRaWAN_COMMANDS[82])),port);
	// create "ok" answer
	sprintf(ans1,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[0])));
	// create "invalid_param" answer
	sprintf(ans2,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[1])));
	...
	strcpy(ans4,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[16])));
	// create "\r\n" answer
	sprintf(carr,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[13])));
 ...
 *  @arg	'7' if input port parameter error
 */
uint8_t arduPiLoRaWAN::sendUnconfirmed(uint8_t port, uint8_t* payload, uint16_t length)
{
	uint8_t status;
	char ans1[20];
	char ans2[20];
	...
	sprintf(_command,(char*)pgm_read_word(&(table_LoRaWAN_COMMANDS[83])),port);
	// create "ok" answer
	sprintf(ans1,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[0])));
	// create "invalid_param" answer
	sprintf(ans2,(char*)pgm_read_word(&(table_LoRaWAN_ANSWERS[1])));
